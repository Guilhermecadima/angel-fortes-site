        ...
        <section className="store-hero">
          ...
          <div className="store-hero-copy">
            ...
            <p>
              ...
              barba e cuidado pessoal
              escolhidos pela Angel
              Fortes.
            </p>
        ...
        <section className="store-catalog">
          ...
          {demoMode && (
            <div className="store-config-banner">
              ...
              Estás a ver produtos
              de demonstração.

              Assim que colocares as
              chaves do Supabase, esta
              página passa a usar os
              produtos criados no
              painel.
